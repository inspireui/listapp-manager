...
class PageTemplater
{
    ...
    private function __construct()
    {
        ...
        $this->templates = ['checkout.php' => 'Mstore Check Out'];
    ...
    public function create_checkout_page(){
        ...
        $result = $wpdb->get_var($wpdb->prepare("SELECT * FROM %s AS p INNER JOIN %s AS meta ON p.ID = meta.post_id %s)", $table_insert, $join_table, $where), OBJECT);
        if(empty($result)){
            ...
            update_post_meta($pageid,'_wp_page_template','checkout.php');
